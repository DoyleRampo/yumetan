...
export const communityMessages = {
  ...
  legal: ["規約とポリシー", "약관 및 정책", "条款与政策", "Terms & policies"],
  ...
  legalHint: [
    "購入前に利用規約とプライバシーポリシーをご確認ください。",
    "구매 전에 이용약관과 개인정보 처리방침을 확인하세요.",
    "购买前请阅读使用条款和隐私政策。",
    "Please review the Terms of Use and Privacy Policy before purchasing.",
  ],
  periodMonthly: [
    "1か月（自動更新）",
    "1개월(자동 갱신)",
