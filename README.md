...
16タイプは独自の娯楽的な分類です。MBTIや医学的・心理学的な診断ではありません。「予知」は夢の印象を表す分類名であり、未来の予測を意味しません。キャラクターは「月あかりの仲間たち」16体のオリジナルAI生成イラストです。診断結果・ホーム・図鑑に画像と4言語の設定を表示します。原本・設定・生成プロンプトは [キャラクター素材集](docs/characters/README.md) にまとめています。
